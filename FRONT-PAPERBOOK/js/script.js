// refenciar os controles: input nome, descricao e btncadastrar
...
btncadastrar.onclick = ()=>{
    fetch("http://10.26.44.25:5000/api/v1/categoria/cadastrar", {
        method:"POST",
        headers:{
...
function exibirCategorias(){
    let saida="";
    fetch("http://10.26.44.25:5000/api/v1/categoria/listar")
    .then((response)=>response.json())
    .then((dados)=>{
        dados.map((itens,ix)=>{
...
function apagar(id){
    fetch("http://10.26.44.25:5000/api/v1/categoria/apagar/"+id,{method:"DELETE"})
    .then((response)=>response.json())
    .then((dados)=>{
}
