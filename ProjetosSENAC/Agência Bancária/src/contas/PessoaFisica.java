...
public class PessoaFisica {
	...
	public static void main(String[] args) {
		Conta cc1 = new Conta();
		cc1.setCliente("Leando Ramos");
		cc1.setSaldo(10000);
		System.out.println("setCliente: " + cc1.getCliente());
		cc1.exibirSaldo();
		cc1.depositar(5000);
		cc1.exibirSaldo();
		System.out.println("\n-------------------------\n");
		...
		cc2.setSaldo(5000);
		System.out.println("setCliente: " + cc2.getCliente());
		cc2.exibirSaldo();
		cc2.sacar(2000);
		cc2.exibirSaldo();
		System.out.println("\n-------------------------\n");
		...
		System.out.println("setSaldo total: R$ " + total);
	}
}
